...
class FakeClient:
    def get(self, path, params):
        if path == "/games":
            return [{"id": 401000001, "awayTeam": "Away U", "homeTeam": "Home U", "startDate": "2026-09-05T19:30:00Z", "neutralSite": False, "venue": "Stadium", "venueId": 1, "awayConference": "A", "homeConference": "B", "awayPregameElo": 1450, "homePregameElo": 1550}]
        if path == "/ratings/fpi":
            return [{"team": "Away U", "fpi": 1.5}, {"team": "Home U", "fpi": 8.5}]
        if path == "/ratings/sp":
            return [{"team": "Away U", "rating": 2.0, "ranking": 70}, {"team": "Home U", "rating": 9.0, "ranking": 30}]
        if path == "/rankings":
            return [{"polls": [{"poll": "AP Top 25", "ranks": [{"school": "Home U", "rank": 20}]}]}]
